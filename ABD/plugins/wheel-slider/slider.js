...
(function ($) {
	var CarouselEvo = function (element, options) {
		...
		var initDirectionButton = function () {
			var el = element;
			el.append('<a href="javascript:void(0)" class="nextButton" aria-label="Next Button"></a><a href="javascript:void(0)" class="prevButton" aria-label="Prev Button"></a>');
